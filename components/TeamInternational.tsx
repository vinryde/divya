...
import { getInternationalDoctoralScholars } from "@/sanity/queries";
import type { TeamMember } from "@/sanity/types";

export const TeamInternationalDoctoralScholars = () => {
  ...
  useEffect(() => {
    const fetchTeamMembers = async () => {
      try {
        const members: TeamMember[] = await getInternationalDoctoralScholars();
        ...
        console.error("❌ Error fetching International Doctoral Scholars:", error);
      }
    };
