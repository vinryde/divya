...
import { getDoctoralScholars } from "@/sanity/queries";
import type { TeamMember } from "@/sanity/types";

export const TeamDoctoralScholars = () => {
  ...
  useEffect(() => {
    const fetchTeamMembers = async () => {
      try {
        const members: TeamMember[] = await getDoctoralScholars();
        console.log("🔍 Raw Sanity data (Doctoral Scholars):", members);
        ...
        console.error("❌ Error fetching Doctoral Scholars data:", error);
      }
    };
